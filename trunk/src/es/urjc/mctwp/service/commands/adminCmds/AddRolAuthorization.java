...
public class AddRolAuthorization extends Command {
	...
	public Command runCommand() {
		...
		auxRol = rolDao.merge(rol);
		action = actionDao.findById(actionId);
		auxRol.addAction(action);
		rolDao.persist(auxRol);
		
		createLogComment("audit.addRolAuth", action.getName(), auxRol.getName());
		return this;
	}
}
