...
public class FindAllTrials extends ResultCommand<List<Trial>> {
	private TrialDAO trialDao = null;

	public FindAllTrials(BeanFactory bf) {
		super(bf);
		trialDao = (TrialDAO)bf.getBean(BeanNames.TRIAL_DAO);
		setActionName(ActionNames.FIND_ALL_TRIALS);
	}
	...
	public ResultCommand<List<Trial>> runCommand() {
		this.setResult(trialDao.findAll());
		return null;
	}
}
