...
public class LoadProtocolable extends ResultCommand<Protocolable> {
	...
	@Override
	public ResultCommand<Protocolable> runCommand() {
		this.setResult(protocolableDao.findById(sourceId));
		return this;
	}
}
