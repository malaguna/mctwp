...
public class FindStudiesByPatient extends ResultCommand<List<Study>> {
	private StudyDAO studyDao = null;
	private Patient patient = null;
	private Study filter = null;
	...
	public boolean isValidCommand() {
		return super.isValidCommand() && studyDao != null && patient != null;
	}

	@Override
	public ResultCommand<List<Study>> runCommand() {
		this.setResult(studyDao.findStudiesByPatientFiltered(patient, filter));
		return this;
	}
}
