...
public class AddUserModality extends Command {
	private ModalityDAO modalityDao = null;
	private Integer modality = null;
	private UserDAO userDao = null;
	private User userObj = null;
	
	public AddUserModality(BeanFactory bf) {
		super(bf);
	...
	public Command runCommand() throws Exception {
		...
		if(mod != null){
			...
			userObj.addModality(mod);
			userDao.persist(userObj);
			createLogComment("audit.addUserModality", userObj.getFullName(), mod.getName());
		}
