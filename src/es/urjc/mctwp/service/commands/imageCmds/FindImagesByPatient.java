...
public class FindImagesByPatient extends ResultCommand<List<ImageData>> {
	private ImageDataDAO imageDao = null;
	private Patient patient = null;

	public FindImagesByPatient(BeanFactory bf) {
		super(bf);
	...
	public ResultCommand<List<ImageData>> runCommand() {
		this.setResult(imageDao.findImagesByPatient(patient));
		return this;
	}
}
